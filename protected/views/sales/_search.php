...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'middle_name',array('size'=>15,'maxlength'=>15)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'phone_number',array('size'=>60,'maxlength'=>150)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'ext_referance_id'); ?>
		<?php echo $form->textField($model,'ext_referance_id'); ?>
	</div>
