	...
	<div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo Common::modelCount('Partner','status','Y',Yii::app()->user->id);?></h3>
              <p>Partners</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo Common::modelCount('ForkindUser','status','Y',Yii::app()->user->id);?></h3>
              <p>Sales</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo Common::modelCount('Customer','status','Y',Yii::app()->user->id);?></h3>
              <p>Customers</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo Common::modelCount('Category','status','Y',Yii::app()->user->id);?></h3>
              <p>Categories</p>
            </div>
            <div class="icon">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b><?php echo Common::Total('Transaction','trans_amount',Yii::app()->user->id);?></b></span>
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b><?php echo Common::Total('Transaction','points_earned',Yii::app()->user->id);?></b></span>
                    <div class="progress lg">
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><b><?php echo Common::Total('Transaction','points_redeemed',Yii::app()->user->id);?></b></span>
                    <div class="progress lg">
...
var salesChartData = {
  ...
  datasets: [
	  <?php 
      $partnerArray=array();
      $transactionList = Transaction::model()->findAllByAttributes(array('partner_id'=>Yii::app()->user->id));
      if(count($transactionList)>0){
          ...
          $resultArray = implode(',',$partnerArray);?>
          {
              ...
              pointHighlightStroke: '<?php $randomString = md5($data->id);$r = substr($randomString,0,2);$g = substr($randomString,2,2);$b = substr($randomString,4,2);echo '#'.$r.$g.$b;?>',
