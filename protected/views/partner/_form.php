    				...
    				<div class="form-group">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="input-group date has-feedback">
                              ...
                              <?php echo $form->textField($partner, 'established_date', array('class'=>'form-control','autocomplete'=>'off','placeholder' => 'Established Date','autocomplete'=>'off')); ?>
                              <?php echo $form->error($partner,'established_date',array('style'=>'color:#FF0000'));?>
                            </div>
                        </div>
                        <div  class="form-group has-feedback">
                        	<?php echo $form->labelEx($address,'address'); ?>
                            <?php echo $form->textArea($address, 'address', array('class'=>'form-control editors','autocomplete'=>'off','placeholder' => 'Address','data-validation'=>"required",'rows'=>'4','value'=>isset($address->address)?nl2br($address->address):'')); ?>
                                  	...
                                  	<div class="form-group"  id="append_number_<?php echo $i;?>">
                                  		<div class="row">
                        			    	<div class="col-md-12">
                                              ...
                                              <?php echo $form->textField($ph, 'phone_number[]', array('class'=>'form-control','autocomplete'=>'off','placeholder'=>'Phone Number','data-validation'=>"number",'autocomplete'=>'off','onKeyup'=>'checkUnity(this,"phone_number","Phone")','value'=>$ph->phone_number)); ?>
