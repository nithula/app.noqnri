...
class Admin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('first_name, last_name, address, phone, email_id, gender, username, password_filed, status, created_on', 'required'),
			array('first_name, last_name, email_id, gender, profile_image, username, uniq_id', 'length', 'max'=>150),
		    array('phone', 'length', 'min'=>10, 'max'=>13),
		    array('phone','unique'),
		    array('email_id','unique'),
		    array('username','unique'),
		    //array('password_filed','length','min'=>8),
		    //array('password_filed','CheckConfirm'),
		    //array('confirm_password', 'compare', 'compareAttribute'=>'password_filed', 'message' => "Retype Password is incorrect."),
